...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Figurinha.quantidade'
        db.add_column(u'figurinhas_figurinha', 'quantidade',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Figurinha.data'
        db.add_column(u'figurinhas_figurinha', 'data',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Figurinha.usuario'
        db.add_column(u'figurinhas_figurinha', 'usuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Figurinha.quantidade'
        db.delete_column(u'figurinhas_figurinha', 'quantidade')

        # Deleting field 'Figurinha.data'
        db.delete_column(u'figurinhas_figurinha', 'data')

        # Deleting field 'Figurinha.usuario'
        db.delete_column(u'figurinhas_figurinha', 'usuario_id')

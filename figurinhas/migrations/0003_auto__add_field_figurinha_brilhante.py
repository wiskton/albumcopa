...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Figurinha.brilhante'
        db.add_column(u'figurinhas_figurinha', 'brilhante',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Figurinha.brilhante'
        db.delete_column(u'figurinhas_figurinha', 'brilhante')
    ...
    models = {
        ...
        u'figurinhas.figurinha': {
            'Meta': {'ordering': "['id']", 'object_name': 'Figurinha'},
            'brilhante': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
